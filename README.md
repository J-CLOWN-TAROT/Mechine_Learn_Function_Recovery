...
<span style="font-weight:bold;">CFG features  CFG 特点</span>
cfg_size
cfg_avg_degree
cfg_num_degree
...
cfg_sum_loopsize
cfg_sum_sccsize
<span style="font-weight:bold;">CG features  CG 特色</span>
cg_num_callees
cg_num_callers
...
<span style="font-weight:bold;">Instruction features  指令特性</span>
...
inst_num_ctransfer
inst_num_misc
<span style="font-weight:bold;">Type features  类型特征</span>
data_mul_arg_type
data_num_args
data_ret_type
